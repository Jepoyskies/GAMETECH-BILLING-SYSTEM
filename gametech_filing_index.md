...
| **Network Devices & Sync Manager** | `network_manager/views/devices.py`<br>`network_manager/views/sync.py` | `network_manager/urls.py` (`/devices/`, `/devices/devices/<id>/sync/`, `/devices/devices/<id>/setup-profiles/`) | `network_manager/templates/network_manager/device_list.html`<br>`network_manager/templates/network_manager/sync_manager.html` | `network_manager/models.py`<br>`network_manager/sync_services.py` |
