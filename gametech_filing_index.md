...
| **Subscriptions & NOC Dispatch** | `billing/views/api/dashboard.py` (`subscription_plans_data_api`)<br>`billing/views/subscriptions.py` (alias)<br>`billing/views/services.py` (`subscription_plans_view`) | `billing/urls.py` (`/subscriptions/`, `/subscriptions/api/data/`) | `billing/templates/billing/subscription_plans.html`<br>`billing/templates/billing/partials/subscription_plans_table.html`<br>(alias: `subscriptions_list.html`) | `billing/models.py` (`Customer`)<br>`network_manager/models.py` (`MikrotikDevice`)<br>`network_manager/services/base.py` (`MikrotikAPI`) |
| **Service Plans Catalog** | `billing/views/services.py` (`plan_list`) | `billing/urls.py` (`/plans/`) | `billing/templates/billing/plan_list.html` | `billing/models.py` (`SubscriptionPlan`, `AddOnRequest`) |
...
| **Field Dispatch / Tickets** | `dispatch/views.py`<br>`dispatch/views_management.py` | `dispatch/urls.py` (`/dispatch/`, `/dispatch/dashboard/`, `/dispatch/monitoring/`, `/dispatch/internet-install/`, `/dispatch/cignal-install/`, `/dispatch/client-concerns/`, `/dispatch/complete-job/<id>/`, `/dispatch/audit-log/`, `/dispatch/management/`) | `dispatch/templates/dispatch/dashboard.html`, `dispatch_monitoring.html`, `internet_install.html`, `cignal_install.html`, `client_concerns.html`, `complete_job.html`, `audit_log.html`, `management.html`, `_add_record_modal.html`<br>Management Partials: `_management_accounts.html`, `_management_teams_techs.html`, `_management_targets.html`, `_management_dropdowns.html`, `_management_modals.html`, `_management_scripts.html` | `dispatch/models.py` (`Team`, `Technician`, `ConfigOption`, `DispatchRecord`, `MonitoringRecord`, `JobDetail`, `AuditLog`)<br>`dispatch/forms.py` (`DispatchRecordForm`, `MonitoringRecordForm`, `JobDetailForm`) |
...
| **Cignal Play & Box Operations** | `billing/views/cignal_dashboard.py` | `billing/urls.py` (`/cignal-dashboard/`) | `billing/templates/billing/cignal_dashboard.html` | `billing/models.py` (`Customer`, `CignalPlay`, `AddOnRequest`, `Notification`) |
| **Financial Analytics & MRR** | `billing/views/analytics.py` | `billing/urls.py` (`/analytics/`) | `billing/templates/billing/analytics.html` | `billing/models.py` (`Payment`, `Customer`, `SubscriptionPlan`) |
| **Admin Panel (Owner Config)** | `billing/views/admin_settings.py` | `billing/urls.py` (`/admin-panel/`) | `billing/templates/billing/admin_panel.html` | `billing/models.py` (`AddonPlan`, `SystemLog`, `AuditLog`) |
| **Add-on Pricing Tiers** | `billing/views/addon_plans.py` | `billing/urls.py` (`/addon-plans/`, `/addon-plans/create/`, `/addon-plans/edit/<pk>/`, `/addon-plans/delete/<pk>/`, `/addon-plans/toggle/<pk>/`) | `billing/templates/billing/addon_plan_list.html`<br>Modal: `_addon_plan_form_modal.html` | `billing/models.py` (`AddonPlan`) |
