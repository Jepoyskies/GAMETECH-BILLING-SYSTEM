...
urlpatterns = [
    ...
    path(
        "customers/edit/<int:customer_id>/", views.edit_customer, name="edit_customer"
    ),
    path(
        "customers/<int:customer_id>/edit-expiration/",
        views.edit_customer_expiration,
        name="edit_customer_expiration",
    ),
    path(
        "customers/<int:customer_id>/edit-balance/",
        views.edit_customer_balance,
        name="edit_customer_balance",
    ),
    path(
    ...
    path(
        "api/customer/<int:customer_id>/mikrotik-status/",
        views.api_customer_mikrotik_status,
        name="api_customer_mikrotik_status_alias",
    ),
    path(
    ...
    path(
        "customers/verify/<int:customer_id>/",
        views.verify_customer,
        name="verify_customer",
    ),
    path(
        "customers/<int:customer_id>/unverify/",
        views.unverify_customer,
        name="unverify_customer",
    ),
    path(
        "customer/force-suspend/<str:username>/",
        views.customer_force_suspend,
        name="customer_force_suspend",
    ),
    path(
        "customer/kick-session/<str:username>/",
        views.customer_kick_session,
        name="customer_kick_session",
    ),
    path(
        "customer/force-reactivate/<str:username>/",
        views.customer_force_reactivate,
        name="customer_force_reactivate",
    ),
    path(
        "mikrotik-active-users/",
        views.mikrotik_active_users_view,
        name="mikrotik_active_users",
    ),
    path(
        "mikrotik-active-users/api/data/",
        views.mikrotik_active_users_data_api,
        name="mikrotik_active_users_data_api",
    ),
    # Live Monitoring routes
    path(
        "network/health/update/",
        views.update_network_health,
        name="update_network_health",
    ),
    path(
        "network/health/resolve/<str:scope>/<int:item_id>/",
        views.resolve_network_health,
        name="resolve_network_health",
    ),
    path("live-monitoring/", views.live_monitoring_view, name="live_monitoring"),
    path(
        "api/live-monitoring/",
        views.api_live_monitoring_data,
    ...
    path(
        "api/active-usernames/",
        views.api_active_pppoe_usernames,
        name="api_active_pppoe_usernames",
    ),
    # Downdetector routes
    ...
    path(
        ...
        views.subscription_plans_data_api,
    ...
    path(
        "customer/<str:username>/rebate/",
        views.customer_rebate_view,
        name="customer_rebate",
    ),
    path(
        "customer/<str:username>/rollback/",
        views.customer_rollback_view,
        name="customer_rollback",
    ),
    path("payment/success/", views.payment_success_view, name="payment_success"),
    path("logs/payments/", views.payment_logs_view, name="payment_logs"),
    path(
        "logs/payments/<int:payment_id>/edit/",
        views.edit_payment_log_view,
        name="edit_payment_log",
    ),
    path(
        "logs/payments/<int:payment_id>/transfer/",
        views.revert_transfer_payment,
        name="revert_transfer_payment",
    ),
    path(
        "logs/payment-addons/", views.payment_addon_logs_view, name="payment_addon_logs"
    ),
    # Payment Processing
    ...
    path(
        "customers/bulk-transfer/",
        views.bulk_transfer_router,
        name="bulk_transfer_router",
    ),
    ...
    path(
        ...
        views.approve_cignal_request,
        name="approve_cignal_request",
    ),
    path(
        "customer/<int:customer_id>/cignalplay-form/",
        views.cignalplay_form_view,
        name="cignalplay_form",
    ),
    path(
        "customer/<int:customer_id>/cignal-logs/",
        views.user_cignal_logs_view,
        name="user_cignal_logs",
    ),
    path(
        "customer/<int:customer_id>/soa/",
        views.statement_of_account_view,
    ...
    path(
        "settings/account-types/add/",
        views.create_account_type,
        name="create_account_type",
    ),
    path(
        "settings/account-types/edit/<int:pk>/",
        views.edit_account_type,
        name="edit_account_type",
    ),
    path(
        "settings/account-types/delete/<int:pk>/",
    ...
    path(
        "settings/barangays/edit/<int:pk>/", views.edit_barangay, name="edit_barangay"
    ),
    path(
        "settings/barangays/delete/<int:pk>/",
    ...
    path(
        ...
        views.update_message_template,
        name="update_message_template",
    ),
    path(
        "api/live-addon-requests/",
        views.live_addon_requests_api,
        name="live_addon_requests_api",
    ),
    path(
        "api/resolve-addon-request/",
        views.resolve_addon_request_api,
        name="resolve_addon_request_api",
    ),
    # Notifications
    ...
    path(
        "api/notifications/mark-read/<int:notif_id>/",
    ...
    path(
        ...
        views.submit_improvement_request,
        name="submit_improvement_request",
    ),
    path(
        "improvement-requests/",
        views.improvement_requests_list,
        name="improvement_requests_list",
    ),
    # Changelog / System Updates
    path("changelog/", views.changelog_view, name="changelog"),
    # Xendit Integration
    path(
        "customer/<int:customer_id>/xendit/invoice/",
        views.create_xendit_invoice,
        name="create_xendit_invoice",
    ),
