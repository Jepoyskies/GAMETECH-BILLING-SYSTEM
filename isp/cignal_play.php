        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
            <div>
                <div class="page-title">
                    ...
                    <div>
                        <h2 class="mb-0 fw-bold text-primary">Cignal Play Plans</h2>
                ...
                <div class="mt-2 d-flex flex-wrap gap-2">
                    <span class="badge text-bg-success">
                        Active: <?= number_format($active_count) ?>
                    </span>
                    <span class="badge text-bg-danger">
                        Expired: <?= number_format($expired_count) ?>
                    </span>
                    <span class="badge text-bg-secondary">
                        No Plan: <?= number_format($no_plan_count) ?>
                    </span>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="payment_cignal_logs.php" class="btn btn-link p-0" style="text-decoration:none;">
                    <i class="fa-solid fa-angles-down me-1"></i>Cignal Logs
                </a>
            </div>
        </div>
    </div>
            ...
            <table class="table table-hover table-bordered align-middle table-sm-custom mb-0">
                ...
                <tr>
                    ...
                    $columns = [
                        ...
                        'address'       => 'Address',
                        'plan_name'     => 'Plan(s)',
                        'start_date'    => 'Last Expiration Date:',
                ...
                <?php if ($display_rows): ?>
                    <?php foreach ($display_rows as $row): ?>
                        ...
                        <tr>
                            ...
                            <td class="col-date"><?= htmlspecialchars(fmtDate($row['end_date'] ?? '')); ?></td>
                ...
                <?php foreach ($display_rows as $row): ?>
                    ...
                    <div class="card card-mobile mb-3 shadow-sm">
                        ...
                        <div class="card-body py-2">
                            ...
                            <hr class="my-2">
                            <div class="mt-1"><strong>Plan(s):</strong> <?= htmlspecialchars($row['plan_name'] ?? ''); ?></div>
                            <div class="mt-1"><strong>Last Expiration Date:</strong> <?= htmlspecialchars(fmtDate($row['start_date'] ?? '')); ?></div>
                            <div class="mt-1"><strong>New Expiration Date:</strong> <?= htmlspecialchars(fmtDate($row['end_date'] ?? '')); ?></div>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
