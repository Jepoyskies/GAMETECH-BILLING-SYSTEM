...
if (isset($_GET['export']) && $_GET['export'] === '1') {
    ...
    fputcsv($out, [
        'id','customer_id','subscriber_no','plan_name','rates',
...
<head>
    <meta charset="UTF-8" />
    <title>Payment Add_on Logs</title>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
            <div>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h3 class="mb-0 fw-bold text-primary">Payment add_on Logs</h3>
        ...
        <div class="table-responsive d-none d-md-block">
            <table class="table table-hover table-bordered mb-0">
                ...
                <?php if ($rows): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="13" class="text-center py-4 muted">No logs found.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
